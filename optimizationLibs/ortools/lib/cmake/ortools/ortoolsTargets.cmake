...
set_target_properties(ortools::ortools_math_opt PROPERTIES
  ...
  INTERFACE_SOURCES "\$<TARGET_OBJECTS:ortools_math_opt_core>;\$<TARGET_OBJECTS:ortools_math_opt_core_c_api>;\$<TARGET_OBJECTS:ortools_math_opt_cpp>;\$<TARGET_OBJECTS:ortools_math_opt_io>;\$<TARGET_OBJECTS:ortools_math_opt_labs>;\$<TARGET_OBJECTS:ortools_math_opt_solvers>;\$<TARGET_OBJECTS:ortools_math_opt_storage>;\$<TARGET_OBJECTS:ortools_math_opt_validators>"
)
...
set_target_properties(ortools::ortools PROPERTIES
  ...
  INTERFACE_COMPILE_DEFINITIONS "OR_BUILD_DLL;OR_PROTO_DLL=__declspec(dllimport);USE_LP_PARSER;USE_MATH_OPT;USE_BOP;USE_CBC;USE_CLP;USE_GLOP;USE_PDLP;USE_SCIP;__WIN32__"
  INTERFACE_COMPILE_FEATURES "\$<IF:\$<CXX_COMPILER_ID:MSVC>,cxx_std_20,cxx_std_17>"
  INTERFACE_COMPILE_OPTIONS "/bigobj;/DNOMINMAX;/DWIN32_LEAN_AND_MEAN=1;/D_CRT_SECURE_NO_WARNINGS;/D_CRT_SECURE_NO_DEPRECATE;/MP;/Zc:preprocessor;/fp:precise;/wd4005;/wd4018;/wd4065;/wd4068;/wd4101;/wd4146;/wd4200;/wd4244;/wd4251;/wd4267;/wd4305;/wd4307;/wd4309;/wd4334;/wd4355;/wd4477;/wd4506;/wd4715;/wd4800;/wd4996"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "ZLIB::ZLIB;absl::base;absl::core_headers;absl::absl_check;absl::absl_log;absl::check;absl::die_if_null;absl::flags;absl::flags_commandlineflag;absl::flags_marshalling;absl::flags_parse;absl::flags_reflection;absl::flags_usage;absl::log;absl::log_flags;absl::log_globals;absl::log_initialize;absl::log_internal_message;absl::cord;absl::random_random;absl::raw_hash_set;absl::hash;absl::leak_check;absl::memory;absl::meta;absl::stacktrace;absl::status;absl::statusor;absl::str_format;absl::strings;absl::synchronization;absl::time;absl::any;protobuf::libprotobuf;re2::re2;Coin::CbcSolver;Coin::OsiCbc;Coin::ClpSolver;Coin::OsiClp;Eigen3::Eigen;libscip;Threads::Threads;psapi.lib;ws2_32.lib"
  INTERFACE_LINK_OPTIONS "/WHOLEARCHIVE:ortools"
...
set_target_properties(ortools::flatzinc PROPERTIES
  ...
  INTERFACE_COMPILE_DEFINITIONS "__WIN32__"
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_COMPILE_OPTIONS "/bigobj;/DNOMINMAX;/DWIN32_LEAN_AND_MEAN=1;/D_CRT_SECURE_NO_WARNINGS;/D_CRT_SECURE_NO_DEPRECATE;/MP;/wd4005;/wd4018;/wd4065;/wd4068;/wd4101;/wd4146;/wd4200;/wd4244;/wd4251;/wd4267;/wd4305;/wd4307;/wd4309;/wd4334;/wd4355;/wd4477;/wd4506;/wd4715;/wd4800;/wd4996"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
...
foreach(_target "ZLIB::ZLIB" "absl::base" "absl::core_headers" "absl::absl_check" "absl::absl_log" "absl::check" "absl::die_if_null" "absl::flags" "absl::flags_commandlineflag" "absl::flags_marshalling" "absl::flags_parse" "absl::flags_reflection" "absl::flags_usage" "absl::log" "absl::log_flags" "absl::log_globals" "absl::log_initialize" "absl::log_internal_message" "absl::cord" "absl::random_random" "absl::raw_hash_set" "absl::hash" "absl::leak_check" "absl::memory" "absl::meta" "absl::stacktrace" "absl::status" "absl::statusor" "absl::str_format" "absl::strings" "absl::synchronization" "absl::time" "absl::any" "protobuf::libprotobuf" "re2::re2" "Coin::CbcSolver" "Coin::OsiCbc" "Coin::ClpSolver" "Coin::OsiClp" "Eigen3::Eigen" "libscip" )
